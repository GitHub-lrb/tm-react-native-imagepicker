                 ...
                 resultHandler:^(NSData *imageData, NSString *dataUTI, UIImageOrientation orientation, NSDictionary *info) {
                     ...
                     dispatch_async(dispatch_get_main_queue(), ^{
                         ...
                         if (processed == [assets count]) {
                             ...
                             [vc setImage:image crop:^(UIImage *cropImage) {
                                 
                                 NSData *data = UIImageJPEGRepresentation(cropImage, 0.3);
                                 ...
                                 self.resolve([self createAttachmentResponse:filePath
                                                                   withWidth:@(cropImage.size.width)
                                                                  withHeight:@(cropImage.size.height)
                                                                    withMime:@"image/jpeg"
                                 ...
                                 UIViewController *topViewController = vc.presentingViewController.presentingViewController;
                                 [topViewController dismissViewControllerAnimated:YES completion:nil];
                             }];
                             UINavigationController *nav = [[UINavigationController alloc]initWithRootViewController:vc];
                             [[self getRootVC] presentViewController:nav animated:YES completion:^{
